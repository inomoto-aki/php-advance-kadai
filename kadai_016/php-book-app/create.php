...
if(isset($_POST['submit'])){
  try{
    ...
    $sql_insert = '
    INSERT INTO books(book_code,book_name,print,stock_quantity,genre_code)
    VALUES(:book_code,:book_name,:print,:stock_quantity,:genre_code)
    ';
